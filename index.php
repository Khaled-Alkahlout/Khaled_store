...
<html>
    ...
    <table>
        <tr>
            ...
            <th class= "f_row" width="600"; margen="0";>
                ...
                <br>
                <br>
                <img src="images/payment.jpg" width="300" length="300" >
            </th>
        </tr>
        <tr>
            <td class="Photo"> <img src="images/coffee-machine.jpg" width="180" length="150"></td>
            ...
            <td class="Photo"> <img src="images/Espresso-machine.jpg" width="200" length="170"> </td>
            ...
            <button class="BuyButton">Buy now</button></td></a>
        <tr>
            <td class="Photo"> <img src="images/Coffee-machine-melk.jpg" width="180" length="130"> </td>
    ...
    <table>
        <tr>
            <th class= "contact-img" width = "630"><img src="images/E-mail.jpg" width="150" height="120"></th>
            <th class= "contact-img" width = "630"><img src="images/WhatsApp.jpg" width="110" height="120"></th>
            <th class= "contact-img" width = "630"><img src="images/Instagram.jpg" width="120" height="120"></th>
        </tr>
        <tr>
